    ...
    <div className="container mx-auto py-8">
      ...
      <Tabs value={activeTab} onValueChange={setActiveTab} className="w-full">
        ...
        <TabsContent value="create">
          <Card className="mt-4">
            <div className="p-4">
              <h2 className="text-lg font-bold mb-2">PSCMS Example</h2>
              <p className="text-sm text-muted-foreground">Provide a slug and instructions to generate SEO-optimized content</p>
            </div>
          ...
          {generatedPost && (
            <Card className="mt-4">
              <div className="p-4">
                <h2 className="text-lg font-bold mb-2">Generated Post Preview</h2>
              ...
              <div className="flex gap-2 p-4">
                ...
                {!isEditingGeneratedContent && (
                  <Button onClick={handleEditGeneratedContent}>Edit Content</Button>
                )}
                <Button 
                  variant="secondary" 
                  onClick={() => setGeneratedPost(null)}
